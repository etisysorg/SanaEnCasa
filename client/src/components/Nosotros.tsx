            ...
            <div className='nostros text-center'>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-4 text-center'>
                        ...
                        <h5 className='text-center' style={{ color: 'white', lineHeight: '1.4' }}>
                            Llegar a ser una Asociación con una sólida estructura organizacional que se mantenga en constante crecimiento y que proporcione apoyo a un cada vez un mayor número de familias                        </h5>
                    </div>
                    <div className='col-md-4 text-center'>
